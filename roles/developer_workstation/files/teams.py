...
# Register an Entra public client in the operator's tenant and provide the
# identifier through the role's host-local configuration when enabling this
# optional plugin. No organization-specific application ID is shipped here.
CLIENT_ID = ""
SCOPES = (
